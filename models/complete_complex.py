...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.fc0 = cn.Linear(self.width, self.width)  # input channel is 3: (a(x, y), x, y)
        self.fc1 = cn.Linear(self.width, 128)
        self.fc2 = cn.Linear(128, out_channels)
        
        self.residual = ConvBNActivation(in_channels=in_channels + 2, out_channels=self.width)
        self.complexblock = ComplexBlock(in_channels=in_channels + 2, out_channels=in_channels + 2)
